...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>Successfully built 1233e044cd21 Successfully tagged lcc_pca_kmeans:v1</p><h2 id="_3以特定端口号运行容器" tabindex="-1">3以特定端口号运行容器 <a class="header-anchor" href="#_3以特定端口号运行容器" aria-hidden="true">#</a></h2><p>docker run -itd -p 5004:5000 lcc_pca_kmeans:v4</p><p><img src="`+p+'" alt=""><img src="'+e+'" alt=""></p><h2 id="_4-其他" tabindex="-1">4 其他 <a class="header-anchor" href="#_4-其他" aria-hidden="true">#</a></h2><p>Python已经取消scipy库中imread，imresize，imsave三个函数的使用,在文件中直接写入imresize函数源代码。</p><p>高效准确处理scipy.misc 中imresize、imread导入错误问题 <a href="https://blog.csdn.net/qq_43561314/article/details/126211227" target="_blank" rel="noreferrer">https://blog.csdn.net/qq_43561314/article/details/126211227</a></p><h2 id="_5-迁移与部署" tabindex="-1">5 迁移与部署 <a class="header-anchor" href="#_5-迁移与部署" aria-hidden="true">#</a></h2><p>待更新</p>',24),c=[t];function i(r,C,A,y,d,u){return n(),a("div",null,c)}const g=s(o,[["render",i]]);export{h as __pageData,g as default};
