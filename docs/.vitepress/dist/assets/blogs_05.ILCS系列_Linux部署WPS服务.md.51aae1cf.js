...
<span class="line"><span style="color:#A6ACCD;"> </span></span>
<span class="line"></span></code></pre></div><h2 id="导出容器包-在服务上导入并执行" tabindex="-1">导出容器包-在服务上导入并执行 <a class="header-anchor" href="#导出容器包-在服务上导入并执行" aria-hidden="true">#</a></h2><p>docker save -o mcr_jdk_v20.tar mcr2017jdk8:v20</p><p>docker load -i mcr_jdk_v20.tar</p><p>docker run -d -p 8085:8080 -p 8086:8003 -v /home/wanghaihang/webapps:/usr/local/apache-tomcat-9.0.34/webapps -v /home/wanghaihang/jarpackage:/opt/jarpackage --restart=always</p><p>docker run -d -p 8085:8080 -p 8086:8003 -v /home/wanghaihang/webapps:/usr/local/apache-tomcat-9.0.34/webapps -v /home/wanghaihang/jarpackage:/opt/jarpackage -v /home/wanghaihang/lib:/opt/lib --restart=always mcr2017_jdk8:v20</p><p>docker run -d -p 8085:8080 -p 8086:8003 -v /home/wanghaihang/webapps:/usr/local/apache-tomcat-9.0.34/webapps -v /home/wanghaihang/jarpackage:/opt/jarpackage -v /home/wanghaihang/lib:/opt/lib -v /home/wanghaihang/lib:/opt/lib --restart=always mcr2017_jdk8:v20</p><p><img src="`+c+'" alt=""></p><p>去掉char()重新编译 k_(&#39;/home/wanghaihang/Matlab/clay_/clay_.tif&#39;,&#39;/home/wanghaihang/Matlab/clay_/sand_.tif&#39;,&#39;/home/wanghaihang/Matlab/clay_/silt_.tif&#39;,&#39;/home/wanghaihang/Matlab/clay_/soc_.tif&#39;,&#39;/home/wanghaihang/Matlab/clay_/res.tif&#39;)</p>',114),r=[t];function i(d,C,A,y,b,D){return s(),n("div",null,r)}const h=a(o,[["render",i]]);export{m as __pageData,h as default};
