import{_ as s,o as e,c as a,a as n}from"./app.31017cfd.js";const A=JSON.parse('{"title":"vitepress 引入vue组件","description":"","frontmatter":{},"headers":[{"level":2,"title":"编写VUE组件","slug":"编写vue组件","link":"#编写vue组件","children":[]},{"level":2,"title":"在md界面中使用Vue","slug":"在md界面中使用vue","link":"#在md界面中使用vue","children":[]}],"relativePath":"blogs/04.Web基础/vitepress引入vue.md"}'),l={name:"blogs/04.Web基础/vitepress引入vue.md"},t=n(`<h1 id="vitepress-引入vue组件" tabindex="-1">vitepress 引入vue组件 <a class="header-anchor" href="#vitepress-引入vue组件" aria-hidden="true">#</a></h1><h2 id="编写vue组件" tabindex="-1">编写VUE组件 <a class="header-anchor" href="#编写vue组件" aria-hidden="true">#</a></h2><p>首先要明确的一点就是，Vitepress和Vuepress等工具都是尤大团队开发的方便Vue用户进行个人站点搭建的工具，本质上的Vue生态的一部分，所以想要个性化自己的网站，需要先学习Vue，Vitepress是基于Vite和Vue3.x进行开发的，所以这里的开发需要使用Vue3.x的内容。</p><p>我们在整个目录中新建一个compement文件夹，在其中新建一个.vue文件。</p><h2 id="在md界面中使用vue" tabindex="-1">在md界面中使用Vue <a class="header-anchor" href="#在md界面中使用vue" aria-hidden="true">#</a></h2><div class="language-markdown"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">---</span></span>
