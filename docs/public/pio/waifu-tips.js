...
live2d_settings['homePageUrl']          = 'https://whh-meteor.github.io/xuanmu-blogs/';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://whh-meteor.github.io/xuanmu-blogs/idea/';   // 关于页地址, '{URL 网址}'
