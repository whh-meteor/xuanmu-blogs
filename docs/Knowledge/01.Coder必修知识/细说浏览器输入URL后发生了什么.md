...
作者：今天要比昨天更优秀
链接：https://juejin.cn/post/7073360584749613069


## 总体概览
大体上，可以分为六步，当然每一步都可以详细都展开来说，这里先放一张总览图:
![](img/细说浏览器输入URL后发生了什么/img-2023-02-26-20-30-38.png)
...
![](img/细说浏览器输入URL后发生了什么/img-2023-02-26-20-31-49.png)
...
![](img/细说浏览器输入URL后发生了什么/img-2023-02-26-20-34-08.png)

递归迭代结合起来的过程，可以用一个图表示：

![](img/细说浏览器输入URL后发生了什么/img-2023-02-26-20-34-26.png)
...
![](img/细说浏览器输入URL后发生了什么/img-2023-02-26-20-39-46.png)
...
6. 合成线程发送绘制图块命令给浏览器进程。浏览器进程根据指令生成页面，并显示到显示器上。
 ...
 ![](img/细说浏览器输入URL后发生了什么/img-2023-02-26-20-40-38.png)
...
CSS 样式来源主要有 3 种，分别是通过 link 引用的外部 CSS 文件、style标签内的 CSS、元素的 style 属性内嵌的 CSS。,其样式计算过程主要为：
 ...
 ![](img/细说浏览器输入URL后发生了什么/img-2023-02-26-20-41-33.png)
...
![](img/细说浏览器输入URL后发生了什么/img-2023-02-26-20-43-26.png)
