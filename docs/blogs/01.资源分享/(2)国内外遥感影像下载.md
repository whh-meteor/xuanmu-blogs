...
(United States Geological Survey) USGS 网站是美国地质调查局官网，是美国内政部所属的科学研究机构。负责对自然灾害、地质、矿产资源、地理与环境等方面的科研、监测、收集、分析；对自然资源进行全国范围的长期监测和评估。要求：科学上网
...
要求：科学上网，基本 Javascript 编程能力，google 账号
